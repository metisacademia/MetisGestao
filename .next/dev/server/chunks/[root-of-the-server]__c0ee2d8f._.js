...
async function GET(request) {
    try {
        ...
        const turmas = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].turma.findMany({
            include: {
                moderador: {
                    select: {
                        id: true,
        ...
        const turmasComEstatisticas = turmas.map((turma)=>{
            ...
            turma.avaliacoes.forEach((av)=>{
                avaliacoesPorAluno.set(av.alunoId, {
                    status: av.status
                });
            });
            const concluidas = Array.from(avaliacoesPorAluno.values()).filter((av)=>av.status === 'CONCLUIDA').length;
            const rascunhos = Array.from(avaliacoesPorAluno.values()).filter((av)=>av.status === 'RASCUNHO').length;
        ...
        const totalAvaliacoesMes = turmasComEstatisticas.reduce((acc, t)=>acc + t.concluidas + t.rascunhos, 0);
        const totalAlunosSistema = turmasComEstatisticas.reduce((acc, t)=>acc + t.totalAlunos, 0);
        ...
        const percentualGeralConclusao = totalAlunosSistema > 0 ? Math.round(totalConcluidas / totalAlunosSistema * 100) : 0;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            mes,
            ano,
            estatisticasGerais: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0ee2d8f._.js.map