...
"[project]/app/api/admin/salvar-avaliacao/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const dominiosUnicos = Array.from(new Map(template.itens.map((item)=>[
                item.dominioId,
                item.dominio
            ])).values());
        const scoresPorDominio = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pontuacao$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calcularScoresPorDominio"])(respostasComPontuacao, dominiosUnicos);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dce23aac._.js.map