...
async function GET(request) {
    try {
        ...
        const templates = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].templateAvaliacao.findMany({
            include: {
                _count: {
                    select: {
                        itens: true
...
async function POST(request) {
    try {
        ...
        const template = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].templateAvaliacao.create({
            data: {
                nome,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b4bf4f0._.js.map