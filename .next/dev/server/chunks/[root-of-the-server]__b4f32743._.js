...
"[project]/app/api/admin/alunos/[id]/criar-usuario/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getFirstName(nome) {
    return nome.trim().split(' ')[0].toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '');
}
async function POST(request, { params }) {
    try {
        ...
        let email = baseEmail;
        let suffix = 1;
        let existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].usuario.findUnique({
            where: {
                email
            }
        });
        while(existingUser){
            ...
            existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].usuario.findUnique({
                where: {
                    email
                }
            });
        ...
        const senha_hash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(senha);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4f32743._.js.map