...
"[project]/app/api/moderador/relatorios/exportar/aluno/[alunoId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const idade = aluno.data_nascimento ? Math.floor((Date.now() - new Date(aluno.data_nascimento).getTime()) / (365.25 * 24 * 60 * 60 * 1000)) : '';
        const headers = [
            'ID_aluno',
            'Nome_aluno',
            'Data_avaliacao',
        ...
        const rows = avaliacoes.map((av)=>{
            ...
            return [
                aluno.id,
                aluno.nome,
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(av.data_aplicacao, 'dd/MM/yyyy'),
                av.mes_referencia,
                av.ano_referencia,
                idade,
        ...
        const filename = `metis_aluno_${aluno.nome.replace(/\s+/g, '_')}_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd')}.csv`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82145d0f._.js.map