...
"[project]/app/api/moderador/relatorios/alunos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const alunos = turmas.flatMap((turma)=>turma.alunos.map((aluno)=>({
                    id: aluno.id,
                    nome: aluno.nome,
                    turma: {
                        id: turma.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(alunos);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4b4160cd._.js.map